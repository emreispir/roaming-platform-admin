export const environment = {
  ...
  // api_base_url_v1: 'https://localhost:5001',
  api_base_url_v2: '',
  api_base_url_v3: '',
  ...
  ad_b2c_redirect_url: 'http://localhost:4200/oauth-token',
  stripe_public_key:
    'pk_test_51O89bgFBrrF2iLpfjkXmlZbnMRSqd7yb8QirzspGZtqiuouJOakqCmCuMIHnP8mS8zdzFq5WEhLkPpTP9sfCllkZ00g7jlg4qb',
  nomupaySuccessRedirectUrl: 'http://localhost:4200/settings?response=success',
  nomupayErrorRedirectUrl: 'http://localhost:4200/settings?response=error',
