...
// @ts-ignore
import { ReviewDtoPaginatedList } from '../model/reviewDtoPaginatedList';
...
export class ReviewsService {
    ...
    public reviewsCreateWithPhotosPost(chargePointId: string, rating: number, xApplicationClientId?: string, comment?: string, chargeSessionId?: string, photos?: Array<object>, files?: Array<Blob>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any> {
        ...
        if (chargePointId !== undefined) {
            localVarFormParams = localVarFormParams.append('ChargePointId', <any>chargePointId) as any || localVarFormParams;
        }
        if (rating !== undefined) {
        ...
        if (chargeSessionId !== undefined) {
            localVarFormParams = localVarFormParams.append('ChargeSessionId', <any>chargeSessionId) as any || localVarFormParams;
        }
        if (photos) {
        ...
        let localVarPath = `/reviews/create-with-photos`;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public reviewsGet(pageNumber?: number, pageSize?: number, workspaceId?: string, chargePointId?: string, userId?: string, orderBy?: OrderBy, sortBy?: string, xApplicationClientId?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<ReviewDtoPaginatedList>;
    public reviewsGet(pageNumber?: number, pageSize?: number, workspaceId?: string, chargePointId?: string, userId?: string, orderBy?: OrderBy, sortBy?: string, xApplicationClientId?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<ReviewDtoPaginatedList>>;
    public reviewsGet(pageNumber?: number, pageSize?: number, workspaceId?: string, chargePointId?: string, userId?: string, orderBy?: OrderBy, sortBy?: string, xApplicationClientId?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<ReviewDtoPaginatedList>>;
    public reviewsGet(pageNumber?: number, pageSize?: number, workspaceId?: string, chargePointId?: string, userId?: string, orderBy?: OrderBy, sortBy?: string, xApplicationClientId?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.request<ReviewDtoPaginatedList>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public reviewsPost(xApplicationClientId?: string, createReviewCommand?: CreateReviewCommand, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<BaseResponseDto>;
    public reviewsPost(xApplicationClientId?: string, createReviewCommand?: CreateReviewCommand, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<BaseResponseDto>>;
    public reviewsPost(xApplicationClientId?: string, createReviewCommand?: CreateReviewCommand, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<BaseResponseDto>>;
    public reviewsPost(xApplicationClientId?: string, createReviewCommand?: CreateReviewCommand, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
